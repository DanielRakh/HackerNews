...
- (instancetype)initWithComment:(HNComment *)comment {
    ...
    if (self) {
        ...
        NSDictionary *opts = @{DTDefaultFontName : @"AvenirNext-Regular", DTDefaultFontSize: @(14.0)};
        _text = [[NSAttributedString alloc] initWithHTMLData:[comment.text_ dataUsingEncoding:NSUTF16StringEncoding] options:opts documentAttributes:NULL];
    }
